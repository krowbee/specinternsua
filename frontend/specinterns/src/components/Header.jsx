    ...
    return (
        <header className="header m-0 p-5 flex flex-col md:flex-row w-full h-[5rem] justify-between items-center bg-[#414143]">
            ...
            <nav className="nav flex flex-col md:flex-row">
             ...
             {store.isAuth ? (
                    <Link to='workshop/login'><button className='btn flex flex-row align-center justify-center hover:bg-[#f77031] hover:text-[white] bg-[#bdbec3] text-[#404145] login-btn'>Workshop</button></Link>
                ) : ('')}
